...
export PATH="/root/Toolchain/arm_gcc-11.2/gcc-arm-11.2-2022.02-aarch64-aarch64-none-elf/bin:/root/Toolchain/arm_gcc-11.2/gcc-arm-11.2-2022.02-aarch64-arm-none-eabi/bin:$PATH"
...
if [ $CH = "true" ]
then
    make -j4 ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-none-elf-" CROSS_COMPILE_ARM32="ccache arm-none-eabi-" ${KD}
    make -j4 ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-none-elf-" CROSS_COMPILE_ARM32="ccache arm-none-eabi-" 2>&1 | tee kernel.log
else
    make ${args} ${KD}                                                                      make ${args} 2>&1 | tee kernel.log
fi
