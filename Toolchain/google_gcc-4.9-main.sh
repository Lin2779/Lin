...
make -j4 ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-linux-android-" CROSS_COMPILE_ARM32="ccache arm-linux-androideabi-" ${KD}

make -j4 ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-linux-android-" CROSS_COMPILE_ARM32="ccache arm-linux-androideabi-" 2>&1 | tee kernel.log
