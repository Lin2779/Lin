...
export PATH="/root/Toolchain/arm_gcc-5/bin:$PATH"
...
make ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-elf-" CROSS_COMPILE_ARM32="ccache arm-eabi-" ${KD}


make ARCH=arm64 SUBARCH=arm64 O=out CROSS_COMPILE="ccache aarch64-elf-" CROSS_COMPILE_ARM32="ccache arm-eabi-" 2>&1 | tee kernel.log
